          ...
          <div className="mt-8 space-y-4 p-4 bg-secondary/50 rounded-lg border border-border/50 text-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1 p-3 bg-background rounded-md shadow-sm">
                ...
                <div className="flex justify-between"><span className="text-muted-foreground">User:</span> <span className="font-mono font-bold">Ask <a href="https://api.whatsapp.com/send?phone=2347081472383&text=Hello%20Ashura" style={{ color: 'blue', textDecoration: 'underline' }}>Ashura</a></span></div>
                <div className="flex justify-between"><span className="text-muted-foreground">Pass:</span> <span className="font-mono font-bold">Ask <a href="https://api.whatsapp.com/send?phone=2347081472383&text=Hello%20Ashura" style={{ color: 'blue', textDecoration: 'underline' }}>Ashura</a></span></div>
              </div>
